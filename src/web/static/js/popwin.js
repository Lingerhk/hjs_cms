...
showWin: function(width, height, title, src, params) {
        ...
        inntHtml += '</div>'
        inntHtml += '<iframe id="iframe_div" width="' + width + '" height="' + iframeHeight + '" frameborder="0" scrolling="' + this.scrolling + '" src="' + src + '"></iframe>';
